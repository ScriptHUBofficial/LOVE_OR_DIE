...
from sayfa4 import Ui_ihackyou4
from sayfa6 import Ui_ihackyou6

class Ui_ihackyou3( QtWidgets.QMainWindow ):
    def __init__(self): #*****
        super().__init__() #*****
    ...
    def setupUi(self):
        ...
        self.evet.clicked.connect(self.tamam)
    ...
    def retranslateUi(self):
        ...
        self.text1.setText(_translate("ihackyou", "Sevgilim olur musun ?"))
